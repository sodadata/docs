...
* You have [installed Soda Core]({% link soda-library/install.md %}) in your environment and [connected]({% link soda-library/configure.md %}) it to your Soda Cloud account.
