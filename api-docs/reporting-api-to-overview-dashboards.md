...
* You have [installed Soda SQL]({% link soda-sql/installation.md %}) in your environment and [connected]({% link soda-sql/connect_to_cloud.md %}) it to your Soda Cloud account.
