...
| x  | Add an identity to a check. | [Add a check identity]({% link soda-cl/optional-config.md %}#add-a-check-identity) <br />***Known issue:*** Failed rows checks do not support the check identity parameter. <!--SAS-2005-->|
