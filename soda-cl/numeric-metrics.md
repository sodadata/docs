...
| `duplicate_count`   | The count of distinct values that have duplicates. <br> Multiple column names can be specified to count duplicate sets of values, as in `duplicate_count(a, b)` <br />See also: [Duplicate check]({% link soda/quick-start-sodacl.md %}#duplicate-check) | number<br /> text<br /> time | all                                                                        |
