...
Consider following the [Take a sip of Soda]({% link soda/quick-start-sip.md %}) quick start that guides you through the steps to configure Soda Core and run a scan of your data.
