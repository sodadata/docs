...
* Made corrections to the connection details for [Athena]({% link soda/connect-athena.md %}) and [Redshift]({% link soda/connect-aredshift.md %}); access keys are required parameters for each, regardless of whether you also use a `role_arn` parameter.
