...
* Updated [Create monitors and alerts]({% link soda-cloud/agreements.md %}#metric-types) to include custom metrics as part of creation flow; updated prerequisites.
