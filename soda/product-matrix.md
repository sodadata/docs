...
| Connect to a data source via a web app user interface| | ![preview](/assets/images/preview.png){:height="60px" width="60px"} |
...
| Write new checks in a web app user interface  |  | ![preview](/assets/images/preview.png){:height="60px" width="60px"} |
| Use historic measurements of data when defining checks  | ![done](/assets/images/done.png){:height="20px" width="20px"} | ![preview](/assets/images/preview.png){:height="60px" width="60px"} |
| Use built-in metrics to write checks | ![done](/assets/images/done.png){:height="20px" width="20px"} | ![preview](/assets/images/preview.png){:height="60px" width="60px"} |
| Use your own custom metrics to write checks | ![done](/assets/images/done.png){:height="20px" width="20px"} | ![preview](/assets/images/preview.png){:height="60px" width="60px"} |
| Include SQL queries in checks for data quality  | ![done](/assets/images/done.png){:height="20px" width="20px"} | ![preview](/assets/images/preview.png){:height="60px" width="60px"} |
| Use SodaCL to write human-readable checks for data quality | ![done](/assets/images/done.png){:height="20px" width="20px"}  | ![preview](/assets/images/preview.png){:height="60px" width="60px"} |
| Define an anomaly detection check  | ![done](/assets/images/done.png){:height="20px" width="20px"} | ![preview](/assets/images/preview.png){:height="60px" width="60px"} |
| Define a schema check | ![done](/assets/images/done.png){:height="20px" width="20px"} | ![preview](/assets/images/preview.png){:height="60px" width="60px"} |
| Apply freshness checks, reference checks, and row-count comparisons between datasets  | ![done](/assets/images/done.png){:height="20px" width="20px"} | ![preview](/assets/images/preview.png){:height="60px" width="60px"} |
...
| Prepare service level agreements for data quality with stakeholders in your organization |  | ![preview](/assets/images/preview.png){:height="60px" width="60px"} |
...
| Feature or functionality |  ![soda-core-logo](/assets/images/soda-core-logo.png){:height="110px" width="110px"} <br />**+** ![sodacl-logo](/assets/images/sodacl-logo.png){:height="75px" width="75px"} |![soda-cloud-logo](/assets/images/soda-cloud-logo.png){:height="150px" width="150px"} | 
|--------|:---------:|:---------:|
| Take advantage of automatic data profiling for datasets and columns |  | ![preview](/assets/images/preview.png){:height="60px" width="60px"} |
