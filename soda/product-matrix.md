...
| Connect to a data source via a web app user interface| | ![done](/assets/images/done.png){:height="20px" width="20px"} |
...
| Write new checks in agreements in the web app user interface |  | ![done](/assets/images/done.png){:height="20px" width="20px"} |
| Use historic measurements of data when defining checks  | ![done](/assets/images/done.png){:height="20px" width="20px"} | ![done](/assets/images/done.png){:height="20px" width="20px"}|
...
| Use SodaCL to write human-readable checks for data quality | ![done](/assets/images/done.png){:height="20px" width="20px"}  | ![done](/assets/images/done.png){:height="20px" width="20px"} |
...
| Define a schema check | ![done](/assets/images/done.png){:height="20px" width="20px"} | ![done](/assets/images/done.png){:height="20px" width="20px"} |
...
| Prepare service level agreements for data quality with stakeholders in your organization |  | ![done](/assets/images/done.png){:height="20px" width="20px"} |
...
|Define filters to test specific portions of data for quality   | ![done](/assets/images/done.png){:height="20px" width="20px"} |![done](/assets/images/done.png){:height="20px" width="20px"} |
