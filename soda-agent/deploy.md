...
## Set up a Kubernetes cluster and deploy a Soda Agent
...
These deployment instructions offer generic guidance for setting up a Kubernetes cluster and deploying a Soda Agent in it. 
