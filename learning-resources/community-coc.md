---
description: >-
  Reference the Soda Community Code of Conduct for guidelines for behaviors. Be
  safe, be respectful, be yourself.
---
...
* Deliberate misgendering, using inappropriate pronouns, or use of [“dead”](https://en.wikipedia.org/wiki/Deadnaming) or rejected names.
...
* Jokes that resemble the above, such as [hipster racism](https://en.wikipedia.org/wiki/Hipster_racism), still count as harassment even if meant satirically or ironically.
